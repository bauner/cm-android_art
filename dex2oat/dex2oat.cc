...
#define CHECK_WATCH_DOG_PTHREAD_CALL(call, args, what) \
 ...
 private:
  ...
  // 59 minutes scaled by kSlowdownFactor. This is slightly smaller than the Package Manager
  ...
  static constexpr int64_t kWatchDogTimeoutSeconds = kSlowdownFactor * (59 * 60);
